...
int main(int argc, char* argv[])
{
	...
	******************************************************************/
	...
	cudaMalloc(&dA, sizeof(float) * sizeA); cudaMemset(dA, 0, sizeof(float) * sizeA);
	cudaMalloc(&dB, sizeof(float) * sizeB); cudaMemset(dB, 0, sizeof(float) * sizeB);
	cudaMalloc(&dC, sizeof(float) * sizeC); cudaMemset(dC, 0, sizeof(float) * sizeC);
	...
	// Hint: cudaMemcpy
	cudaMemcpy(Cgpu, dC, sizeof(float) * sizeC, cudaMemcpyDeviceToHost);
	timer.offTimer(3);
